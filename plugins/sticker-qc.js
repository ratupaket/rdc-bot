...
let apiColor = randomColor[Math.floor(Math.random() * randomColor.length)];
    ...
    let pp = await conn.profilePictureUrl(m.sender, 3000, 'image').catch(_ => 'https://telegra.ph/file/320b066dc81928b782c7b.png')
   ...
   let stiker = await sticker(buffer, false, pauthor)
