...
class SnakeAndLadderGame {
  constructor(client) {
    ...
    this.player1ImageUrl = "https://cdn.icon-icons.com/icons2/2620/PNG/512/among_us_player_red_icon_156942.png";
    this.player2ImageUrl = "https://cdn.icon-icons.com/icons2/2620/PNG/512/among_us_player_green_icon_156937.png";
    this.bgImage = null;
  ...
  async playTurn(m, player) {
    ...
    if(this.currentPositions[player] === this.boardSize) {
      ...
      this.resetSession();
      client.ulartangga[m.chat] = new GameSession(m.chat, client);
...
const handler = async(m, {
  ...
  const session = sessions[m.chat] || (sessions[m.chat] = new GameSession(m.chat, conn));
  ...
  switch(args[0]) {
    ...
    case "reset":
      ...
      conn.ulartangga[m.chat] = new GameSession(m.chat, conn);
